        ...
        <div className="profile-container">
            ...
            <div className="profile-header">
                <div className="logo-title-container">
                    ...
                    <div className="profile-title-container">
                        <h1 className="main-title">SRI Assessment Tool</h1>
            ...
            <div className="profile-main">
                ...
                <div className="profile-menu">
                    ...
                    <div className="profile-button-container">
                        <button className="profile-button my-account" onClick={() => navigate('/profile')}>
                            <FaUser size={30} />
                            <span className="profile-button-text">My Account</span>
                        </button>
                    </div>
                </div>
                ...
                <div className="profile-welcome">
                    ...
                    <p className="profile-welcome-subtitle">Please select the services that are applicable in your building.</p>
                                    ...
                                    {services.map(service => (
                                        <div key={service.code} className="service-container">
                                            <div className="service-header">
                                                <span className="service-description" style={{ color: mandatoryServices[activeDomain]?.includes(service.code) ? 'red' : 'black' }}>
